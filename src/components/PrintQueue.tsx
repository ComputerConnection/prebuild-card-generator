...
export const PrintQueue = memo(function PrintQueue() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4" role="region" aria-labelledby={`${baseId}-heading`}>
      <div className="flex items-center justify-between mb-3">
        <h2 id={`${baseId}-heading`} className="text-lg font-semibold text-gray-800 flex items-center gap-2">
      ...
      {isProcessing && progress && (
        ...
        >
          ...
          <div className="text-xs text-purple-600 mb-2 truncate">
              ...
              <div className="flex-1 min-w-0">
                ...
                {preset.config.price > 0 && (
                  <div className="text-xs text-gray-500">
                    {formatPrice(preset.config.price)}
                  </div>
                )}
              </div>
